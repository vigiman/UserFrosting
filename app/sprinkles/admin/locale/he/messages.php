 ...
 * he
 *
 * Hebrew message token translations for the 'admin' sprinkle. By Shoham Vigiser - still in progress
 *
...
return [
    ...
    "GROUP" => [
        ...
        "NAME"          => "שם הקבוצה",
        "NAME_EXPLAIN"  => "נא להכניס שם עבור הקבוצה",
    ...
    "MIGRATION" => [
        "REQUIRED"          => "נדרש לעדכן את מסד הנתונים"
    ],
